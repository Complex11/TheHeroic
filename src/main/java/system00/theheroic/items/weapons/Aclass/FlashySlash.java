...
public class FlashySlash extends ToolSword {

	public FlashySlash(String name, ToolMaterial material) {
		super(name, material);
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(Reference.MODID + ":weapons/aclass/flashy_slash", "inventory"));
	}
}